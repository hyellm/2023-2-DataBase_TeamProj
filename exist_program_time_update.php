<?php
    ...
    $sql1 ="SELECT *FROM program_time 
            ...
            AND start_date='".$_GET['start_date']."'";
            
    $ret1 = mysqli_query($con, $sql1);

    $row=mysqli_fetch_array($ret1);
    $serial=$row["program_serial"];
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "UPDATE program_time
                SET start_time='".$start_time."', finish_time='".$finish_time."', start_date='".$start_date."', finish_date='".$finish_date."',day='".$day."'
                WHERE program_serial = '".$serial."' AND start_date='".$original_start_date."'
    ...
    $_SESSION['previous_page'] = 'exist_program_time_update.php';
...
<BODY>
    ...
    <input type="hidden" name="original_start_date" value="<?php echo $row['start_date']; ?>">
        ...
        프로그램 번호 : <INPUT TYPE = "text" NAME="program_serial" VALUE=<?php echo $serial?> readonly>
        <br>
