<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql="DELETE FROM child_interest
                WHERE child_serial='".$child_serial."' AND cate_serial='".$cate_serial."'";
...
<BODY>
    ...
    <FORM METHOD="post" ACTION="">
        ...
        <br>
        흥미도 레벨 : <INPUT TYPE="number" NAME="inter_level" min="1" max="5" value=<?php echo $inter_level?> readonly><br>
        <br><br>
        <input Type="submit" VALUE="흥미도 삭제">
    </FORM>
</BODY>
</HTML>
