<?php
    ...
    $sql ="SELECT *FROM program_capacity 
            WHERE program_serial='".$_GET['program_serial']."' 
            AND capa_serial='".$_GET['capa_serial']."'";
    ...
    $level = $row["capa_level"];

    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        $serial=$_POST["program_serial"];
        $capa_serial=$_POST["capa_serial"];
    
        $sql="DELETE FROM program_capacity 
              WHERE program_serial='".$serial."' AND capa_serial='".$capa_serial."'";
...
<BODY>
    ...
    <FORM METHOD="post" ACTION="">
        ...
        <br>
        역량 레벨 : <INPUT TYPE = "number" NAME="capa_level" VALUE=<?php echo $level?> readonly>
        <br><br>
