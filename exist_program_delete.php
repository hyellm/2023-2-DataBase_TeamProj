<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql="DELETE FROM program WHERE program_serial='".$serial."'";
...
<BODY>
    ...
    <FORM METHOD="post" ACTION="">
        ...
        <br>
        상세설명 : <INPUT TYPE = "text" NAME="program_detail" VALUE=<?php echo $detail?> readonly>
        <br>
        외부여부 : <INPUT TYPE = "text" NAME="inout_sep" VALUE=<?php echo $inout?> readonly>
        <br>
